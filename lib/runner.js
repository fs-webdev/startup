...
if (toobusy && TOOBUSY_LAG) toobusy.maxLag(TOOBUSY_LAG);
 ...
 */
if (process.env.MAX_CLIENT_SOCKETS) {
  https.globalAgent.maxSockets = http.globalAgent.maxSockets = envs.int('MAX_CLIENT_SOCKETS', Infinity);
}
...
var server = http.createServer(function (req, res) {
  ...
  if (TOOBUSY_LAG && toobusy && toobusy()) {
